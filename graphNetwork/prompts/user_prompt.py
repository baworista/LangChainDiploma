"""
Module: user_prompt_template.

This module defines the template for generating user prompts in a multi-agent system workflow.

The `USER_PROMPT_TEMPLATE` is designed to guide the user through a structured workflow by providing
relevant information, tasks, analysis, and questions for the next agent. It ensures that agents
collaborate effectively, ask the right questions, and adhere to the established process.
