...
*(To access the code documentation, please navigate to: docs/build/html/index.html)*
...
- **G-Eval Evaluation**: Reports are analyzed against predefined criteria (Relevance, Factuality, Completeness, Clarity, Actionability) to generate detailed scores and feedback.   

**Note**: The graph is scalable and can accommodate additional evaluators as needed.   
